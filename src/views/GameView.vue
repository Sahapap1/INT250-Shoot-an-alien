...
<div class="relative w-screen h-screen">
    ...
    <div class="flex justify-center px-2 sm:px-4">
        <div class="bg-purple-500/20 pt-3 sm:pt-6 pb-4 sm:pb-7 px-4 sm:px-11 mt-2 sm:mt-3
            max-w-5xl w-full rounded-3xl sm:rounded-4xl shadow-xl text-center text-shadow-2xs border-[#430d4d]/50 border-4 space-y-2">
            
            <div class="flex items-center justify-between gap-2">
                <div class="bg-cyan-600 space-y-1 inline-block px-3 sm:px-8 py-1 rounded-4xl">
                    <h1 class="text-2xl sm:text-4xl md:text-5xl text-white text-shadow-2xs font-kanit">
                        999,999
                    </h1>
                </div>
                <h1 class="text-lg sm:text-3xl md:text-5xl font-bold text-cyan-600 mt-1 sm:mt-2 shadow-2xl font-kanit tracking-tight leading-tight text-center">
                    SHOOT-AN-ALIEN
                </h1>
                <div class="bg-black/30 space-y-1 inline-block px-3 sm:px-8 py-1 rounded-4xl shadow-2xl">
                    <h1 class="text-2xl sm:text-4xl md:text-5xl text-white text-shadow-2xs font-kanit">
                        03.00
                    </h1>
                </div>
            ...
            <div class="bg-yellow-400/60 space-y-1 inline-block px-8 sm:px-25 py-1 rounded-4xl mx-auto text-shadow-2xs shadow-2xl">
                <h1 class="text-xl sm:text-3xl text-white text-shadow-2xs font-kanit">
                    MEDIUM
                </h1>
            </div>
        </div>
    ...
    >
      ...
      <svg v-if="isPaused" xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 sm:w-7 sm:h-7" viewBox="0 0 24 24" fill="currentColor">
        <polygon points="5 3 19 12 5 21 5 3"></polygon>
      </svg>
      <svg v-else xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 sm:w-7 sm:h-7" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round">
